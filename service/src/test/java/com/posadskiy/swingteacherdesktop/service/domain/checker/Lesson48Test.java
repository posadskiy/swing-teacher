...
class Lesson48Test {
    ...
    @Test
    void testTask2() {
        String rightSolution = "FocusListener-focusLost-getText-setBackground";
    ...
    @Test
    void testTask3() {
        String rightSolution = "Component-setFocusable-setFocusTraversalKeysEnabled-requestFocus";
