package com.posadskiy.swingteacherdesktop.api.mapper;
...
public final class DtoMapper {
    ...
    public static Optional<User> toUserOptional(UserDto dto) {
        ...
        return Optional.ofNullable(dto)
            .map(d -> {
                var tasks = Optional.ofNullable(d.tasks())
                    .map(t -> t.stream().map(DtoMapper::toTask).toList())
                    .orElse(List.of());
    ...
    public static Keyword toKeyword(KeywordDto dto) {
        return Optional.ofNullable(dto)
            .map(d -> Keyword.of(toInt(d.id()), d.keywordText()))
            .orElse(null);
    }
    
    public static Shorthand toShorthand(ShorthandDto dto) {
        return Optional.ofNullable(dto)
            .map(d -> Shorthand.of(toInt(d.id()), d.shortText(), d.fullText()))
            .orElse(null);
    }
    
    public static Documentation toDocumentation(DocumentationDto dto) {
        return Optional.ofNullable(dto)
    ...
    public static CompletedTask toCompletedTask(CompletedTaskDto dto) {
        return Optional.ofNullable(dto)
            .map(d -> CompletedTask.of(toInt(d.id()), toInt(d.userId()), toInt(d.taskId())))
            .orElse(null);
    }
    
    public static TaskCategory toTaskCategory(TaskCategoryDto dto) {
        return Optional.ofNullable(dto)
